...
maskDir="/home/data/Projects/Zhen/BIRD/mask/CWASMask_noGSR"
...
anatDir=/home/data/Projects/Zhen/BIRD/results/CPAC_zy${preprocessDate}_reorganized/noGSR/T1Img
...
cmd1="3dMean -prefix ${maskDir}/stdMask_110sub_3mm_noGSR.nii.gz $a"
echo $cmd1
eval $cmd1

3dcalc -a ${maskDir}/stdMask_110sub_3mm_noGSR.nii.gz -expr 'step(a-0.99999)' -prefix ${maskDir}/stdMask_110sub_3mm_noGSR_100prct.nii.gz

rm -rf $subIncludedList

## 3. create filepath for all subject
sublistFile="/home/data/Projects/Zhen/BIRD/data/subCWASFunImgFilePath_110sub.txt"
rm -rf $sublistFile
for sub in `cat $subList`; do
