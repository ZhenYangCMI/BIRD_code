...
effect='ME';
measureList={'DegreeCentrality', 'DualRegression0', 'DualRegression1', 'DualRegression2', 'DualRegression3', 'DualRegression4', 'DualRegression5', 'DualRegression6', 'DualRegression7', 'DualRegression8', 'DualRegression9', 'CWASME_ROI1', 'CWASME_ROI2', 'CWASME_ROI3', 'CWASME_ROI4' };
%measureList={'CWASME_ROI1'}
...
outputDir=['/home/data/Projects/Zhen/BIRD/generalizeClassifier/ROImean/'];
clustMeanConcate=[];
clustNameConcate=[];
...
for i=1:length(measureList)
    ...
    if strcmp(measure(1:4), 'CWAS')
        mask=['/home/data/Projects/Zhen/BIRD/mask/stdMask_110sub_compCor_100prct_final.nii.gz'];
T='T1'
    else
 ...
 T='T2'
    ...
    file=['/home/data/Projects/Zhen/BIRD/generalizeClassifier/meanRegress/', measure, '/', measure, '_AllVolume_meanRegress.nii'];
    ...
    maskFileNeg=['/home/data/Projects/Zhen/BIRD/mask/ROImasksME/cluster_mask_', measure, '_', T, '_Z_neg.nii.gz']
    ...
    maskFilePos=['/home/data/Projects/Zhen/BIRD/mask/ROImasksME/cluster_mask_', measure, '_', T, '_Z_pos.nii.gz']
...
xlwrite([outputDir, effect, '_ROImeanAllMeasures_total', num2str(totNumClusters), 'clusters.xls'], subID, 'sheet1','A1');
xlwrite([outputDir, effect, '_ROImeanAllMeasures_total', num2str(totNumClusters), 'clusters.xls'], clustNameConcate, 'sheet1','B1');
xlwrite([outputDir, effect, '_ROImeanAllMeasures_total', num2str(totNumClusters), 'clusters.xls'], clustMeanConcate, 'sheet1','B2');

rowTitle={'measure', 'negative', 'positive'};
xlwrite([outputDir, effect, '_numClustersEachMeasure.xls'],numClusters, 'sheet1', 'B2')
xlwrite([outputDir, effect, '_numClustersEachMeasure.xls'],measureList', 'sheet1', 'A2')
xlwrite([outputDir, effect, '_numClustersEachMeasure.xls'], rowTitle, 'sheet1', 'A1')
