...
processDate='1_24_14';
funImgName='rest_rest_645';
DCmaskName='meanStandFunMask_115sub_90pct';
...
for j=1:length(covTypeList)
    ...
    destinationDir=['/home/data/Projects/BIRD/results/CPAC_zy', processDate, '_reorganized/', covType, '/'];
    ...
    for i=1:numSub
        ...
        subDir=['/home/data/Projects/BIRD/results/output/pipeline_zy', processDate, '/', sub];
        ...
        % name
        fun2anatAffine=['/home/data/Projects/BIRD/results/working/resting_preproc_', sub, '/_scan_', funImgName, '/fsl_reg_2_itk_0/affine.txt'];
        ...
        standFunMask=[subDir, '/functional_brain_mask_to_standard/_scan_', funImgName, '/REST_645_calc_resample_volreg_mask_wimt.nii.gz'];
        ...
        VMHC=[subDir, '/vmhc_raw_score/_scan_', funImgName, '/_csf_threshold_0.96/_gm_threshold_0.7/_wm_threshold_0.96/', pipeline, '/_bandpass_freqs_0.01.0.1/_fwhm_6/bandpassed_demeaned_filtered_maths_wtsimt_tcorr.nii.gz'];
        fALFF=[subDir, '/falff_img/_scan_', funImgName, '/_csf_threshold_0.96/_gm_threshold_0.7/_wm_threshold_0.96/', pipeline, '/_hp_0.01/_lp_0.1/REST_645_calc_resample_volreg_mask_calc.nii.gz'];
        DegreeCentrality=['/home/data/Projects/BIRD/results/output/pipeline_zy', processDate, '/', sub '/centrality_outputs/_scan_', funImgName, '/_csf_threshold_0.96/_gm_threshold_0.7/_wm_threshold_0.96/', pipeline, '/_bandpass_freqs_0.01.0.1/_mask_', DCmaskName, '/degree_centrality_binarize.nii.gz'];
