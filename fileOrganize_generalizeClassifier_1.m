...
subListFile='/home/data/Projects/Zhen/BIRD/generalizeClassifier/data/88AdultsWithBIRD.txt';
...
for j=1:length(covTypeList)
    ...
    destinationDir=['/home/data/Projects/Zhen/BIRD/generalizeClassifier/outPut/', covType, '/'];
    ...
    for i=1:numSub
        ...
        %if ~strcmp(sub, 'M10908258') && ~strcmp(sub, 'M10929973')  % these two subjects missing the wm+csf output
        ...
        if exist(subDir, 'dir')
            ...
            % name
            fun2anatAffine=['/data2/rockland_sample_preprocessing/rest_645_preproc/working/resting_preproc_', sub, '/_scan_', funImgName, '/fsl_reg_2_itk_1/affine.txt'];
