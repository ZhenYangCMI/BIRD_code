...
measureList={'DegreeCentrality', 'DualRegression0', 'DualRegression1', 'DualRegression2', 'DualRegression3', 'DualRegression4', 'DualRegression5', 'DualRegression6', 'DualRegression7', 'DualRegression8', 'DualRegression9' };
numMeasure=length(measureList)

BrainMaskFile=['/home/data/Projects/Zhen/BIRD/mask/meanStandFunMask_110sub_90pct.nii.gz'];

for j=1:numMeasure
    measure=char(measureList{j})
    
    
    mkdir (['/home/data/Projects/Zhen/BIRD/generalizeClassifier/meanRegress/', measure])
    dataOutDir=['/home/data/Projects/Zhen/BIRD/generalizeClassifier/meanRegress/', measure, '/'];
    ...
    for i=1:length(SubID)
        ...
        if strcmp(measure, 'DegreeCentrality')
            FileName = sprintf('/home/data/Projects/Zhen/BIRD/generalizeClassifier/outPut/noGSR/%s/%s_%s_MNI_fwhm6_2mm.nii', measure, measure, sub);
        else
            FileName = sprintf('/home/data/Projects/Zhen/BIRD/generalizeClassifier/outPut/noGSR/%s/%s_%s_MNI_fwhm6.nii', measure, measure, sub);
        end
